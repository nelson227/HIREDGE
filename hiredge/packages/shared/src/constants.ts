...
export const APPLICATION_LIMITS = {
  FREE_MONTHLY: MAX_FREE_APPLICATIONS_PER_MONTH,
  PREMIUM_MONTHLY: Infinity,
} as const;

export const SQUAD_COOLDOWN_APPLICATIONS = 3;
export const SQUAD_COOLDOWN_HOURS = 24;

export const MAX_SQUADS_PER_USER = 5;

export const SQUAD_LIMITS = {
  MIN_SIZE: SQUAD_MIN_SIZE,
  MAX_SIZE: SQUAD_MAX_SIZE,
  MIN_MEMBERS: SQUAD_MIN_SIZE,
  MAX_MEMBERS: SQUAD_MAX_SIZE,
  MAX_SQUADS_PER_USER: MAX_SQUADS_PER_USER,
  INACTIVE_DAYS_NUDGE: SQUAD_INACTIVE_DAYS_NUDGE,
  INACTIVE_DAYS_CHECK: SQUAD_INACTIVE_DAYS_CHECK,
  INACTIVE_DAYS_REPLACE: SQUAD_INACTIVE_DAYS_REPLACE,
  COOLDOWN_APPLICATIONS: SQUAD_COOLDOWN_APPLICATIONS,
  COOLDOWN_HOURS: SQUAD_COOLDOWN_HOURS,
} as const;
