...
export const interviewsApi = {
  ...
  start: (data: { type: string; applicationId?: string; jobId?: string; company?: string; jobTitle?: string; mode?: string }) =>
  ...
  respond: (id: string, message: string, meta?: { durationSeconds?: number; eyeContactPct?: number; responseTimeMs?: number }) =>
    api.post(`/interviews/${id}/respond`, { message, ...meta }),
