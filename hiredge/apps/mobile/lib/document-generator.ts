...
const COUNTRY_CONFIGS: Record<string, CountryConfig> = {
  ...
  US: { pageFormat: 'letter', showPhoto: false, showPersonalDetails: false, showReferences: true, signatureLine: false,
  ...
  CA: { pageFormat: 'letter', showPhoto: false, showPersonalDetails: false, showReferences: true, signatureLine: false,
    sections: { profile: 'Summary', experience: 'Work Experience', education: 'Education', skills: 'Skills', languages: 'Languages', certifications: 'Certifications', interests: 'Interests', references: 'References' } },
  UK: { pageFormat: 'a4', showPhoto: false, showPersonalDetails: false, showReferences: true, signatureLine: false,
    sections: { profile: 'Personal Statement', experience: 'Employment History', education: 'Education', skills: 'Key Skills', languages: 'Languages', certifications: 'Certifications', interests: 'Interests', references: 'References' } },
  DE: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: true,
    sections: { profile: 'Profil', experience: 'Berufserfahrung', education: 'Ausbildung', skills: 'Kenntnisse', languages: 'Sprachen', certifications: 'Zertifikate', interests: 'Interessen', references: 'Referenzen' } },
  ...
  JP: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: true,
    sections: { profile: '概要', experience: '職歴', education: '学歴', skills: 'スキル', languages: '語学', certifications: '資格', interests: '趣味', references: '参照' } },
  AU: { pageFormat: 'a4', showPhoto: false, showPersonalDetails: false, showReferences: true, signatureLine: false,
    sections: { profile: 'Career Objective', experience: 'Employment History', education: 'Education', skills: 'Skills', languages: 'Languages', certifications: 'Certifications', interests: 'Interests', references: 'References' } },
  NL: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: false,
    sections: { profile: 'Profiel', experience: 'Werkervaring', education: 'Opleiding', skills: 'Vaardigheden', languages: 'Talen', certifications: 'Certificaten', interests: 'Interesses', references: 'Referenties' } },
  ES: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: false,
    sections: { profile: 'Perfil', experience: 'Experiencia Profesional', education: 'Formación', skills: 'Habilidades', languages: 'Idiomas', certifications: 'Certificaciones', interests: 'Intereses', references: 'Referencias' } },
  IT: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: true,
    sections: { profile: 'Profilo', experience: 'Esperienza Lavorativa', education: 'Formazione', skills: 'Competenze', languages: 'Lingue', certifications: 'Certificazioni', interests: 'Interessi', references: 'Referenze' } },
  BR: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: false,
    sections: { profile: 'Resumo', experience: 'Experiência Profissional', education: 'Formação', skills: 'Habilidades', languages: 'Idiomas', certifications: 'Certificações', interests: 'Interesses', references: 'Referências' } },
  IN: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: true, signatureLine: true,
    sections: { profile: 'Career Objective', experience: 'Professional Experience', education: 'Education', skills: 'Technical Skills', languages: 'Languages', certifications: 'Certifications', interests: 'Hobbies', references: 'References' } },
  AE: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: true, signatureLine: false,
    sections: { profile: 'Objective', experience: 'Work Experience', education: 'Education', skills: 'Skills', languages: 'Languages', certifications: 'Certifications', interests: 'Interests', references: 'References' } },
  ...
  CN: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: false,
    sections: { profile: '个人简介', experience: '工作经历', education: '教育背景', skills: '技能', languages: '语言', certifications: '证书', interests: '兴趣爱好', references: '推荐人' } },
  KR: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: true,
    sections: { profile: '자기소개', experience: '경력사항', education: '학력', skills: '기술', languages: '언어', certifications: '자격증', interests: '취미', references: '추천인' } },
  RU: { pageFormat: 'a4', showPhoto: true, showPersonalDetails: true, showReferences: false, signatureLine: false,
    sections: { profile: 'О себе', experience: 'Опыт работы', education: 'Образование', skills: 'Навыки', languages: 'Языки', certifications: 'Сертификаты', interests: 'Интересы', references: 'Рекомендации' } },
